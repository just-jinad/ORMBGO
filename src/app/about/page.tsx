...
const page = () => {
  ...
  <section className="py-16 bg-white">
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-gray-300 h-40"></div>
        <div className="bg-gray-300 h-40 col-span-2"></div>
      </div>
    </div>
  </section>
  ...
  <section className="bg-gray-100 py-16">
    <h2 className="text-2xl font-bold text-center mb-8">Meet Our Leaders</h2>
    ...
    <div className="text-center mt-12">
      <button className="bg-gray-800 text-white py-2 px-6 rounded-lg">View the team</button>
    </div>
  </section>
</div>
